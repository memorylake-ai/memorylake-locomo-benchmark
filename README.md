...
![LoCoMo Benchmark Comparison](./benchmark_comparison.png)

Charts (generated by [`plot_results.py`](./plot_results.py)):
- **Overall score** — horizontal bar chart across all systems
- **Score by question type** — grouped bar chart for all 4 categories
- **Category breakdown** — radar chart for top 4 systems
- **Score heatmap** — all systems × categories at a glance
- **Per-record breakdown** — MemoryLake's R1–R10 line chart by question type
